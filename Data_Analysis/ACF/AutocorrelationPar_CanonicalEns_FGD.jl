...
## NB: paper data
Fdata = readdlm("ABCD_Systems/Outcomes/Coeff_MF_SplineI_sC_M100m1.csv", Float64);
...
open("./Data_Analysis/ACF/Outcomes/sC_M0.1m1_FullcorrP(B1.096).csv","w+") do x
   writedlm(x,[ S.dt*S.LagStep*[0:S.NumLags-1;] MomAutocorr ] );
end

open("./Data_Analysis/ACF/Outcomes/sC_M0.1m1_FullcorrF(B1.096).csv","w+") do x
...
#
# open("./Data_Analysis/ACF/Outcomes/sC_M5m1_FullcorrP_OC(B1.096).csv","w+") do x
#     writedlm(x,[ S.dt*S.LagStep*[0:S.NumLags-1;] MomAutocorr ] );
# end
#
# open("./Data_Analysis/ACF/Outcomes/sC_M5m1_FullcorrF_OC(B1.096).csv","w+") do x
#     writedlm(x,[ S.dt*S.LagStep*[0:S.NumLags-1;] StressAutocorr ] );
# end
